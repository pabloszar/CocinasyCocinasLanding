    ...
    <section data-screen-label="03 Diferenciador" id="diferenciador">
      <div className="wrap">
        <div className="sec-head">
          ...
          <h2>Somos los que que van a construir la cocina de tus sueños</h2>
          <p className="sub">Ventajas concretas frente a las opciones que ya cotizaste — verificables hoy mismo.</p>
        </div>
    ...
    <section id="nosotros" style={{ background: 'var(--cream-2)' }} data-screen-label="07 Sobre nosotros">
      <div className="wrap about-grid about">
        <div>
          ...
          <p>
            Creemos que una cocina excepcional no solo se ve bien en un plano, sino que funciona a la perfección en la vida real. Por eso, combinamos nuestro dominio artesanal con tecnología de precisión, creando espacios impecables donde la calidad de los materiales y la obsesión por el detalle hablan por sí mismos.
          </p>
    ...
    <section id="resenas" data-screen-label="08 Reseñas">
      <div className="wrap">
        <div className="sec-head">
          ...
          <p className="sub">Calificación promedio 4.9 / 5 en Google Maps — basadas en proyectos terminados entre 2022 y 2026.</p>
        </div>
    ...
    <section id="contacto" className="contact" data-screen-label="11 Contacto">
      <div className="wrap contact-grid">
        <div className="contact-side">
          ...
          <p>Agenda una Asesoría de Diseño con nuestros expertos. Déjanos cuatro datos y evaluamos la distribución, materiales y viabilidad de tu espacio. Te contactamos de inmediato para trazar la ruta de tu nueva cocina..
        ...
        {!submitted ?
          <form className="form" onSubmit={submit}>
            ...
            <div className="submit-row">
              <button type="submit" className="btn btn-orange">Quiero mi asesoría {I.arrow()}</button>
              <span className="small">o llámanos al <a href="tel:+527223183942" style={{ color: 'var(--orange-soft)' }}>722 318 3942</a></span>
            </div>
            <span className="small">Tus datos solo se usan para coordinar tu asesoría. Cero spam.</span>
          </form> :
